...
Elm.GameBoard.make = function (_elm) {
   ...
   var screenWidth = 400;
   var toElement = function (gameboard) {
      var shape = A2($Graphics$Collage.rect,
      screenWidth,
      screenHeight);
      var border = A2($Graphics$Collage.outlined,
      $Graphics$Collage.solid(gameboard.borderColor),
      shape);
      return A3($Graphics$Collage.collage,
      $Basics.round(screenWidth),
      $Basics.round(screenHeight),
      _U.list([border]));
   };
   var GameBoard = function (a) {    return {borderColor: a};};
   var main = toElement(GameBoard($Color.blue));
